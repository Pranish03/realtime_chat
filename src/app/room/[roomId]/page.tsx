...
const Page = () => {
  ...
  return (
    <main className="flex flex-col h-dvh max-h-dvh overflow-hidden">
      <header className="border-b border-zinc-800 p-4 flex flex-wrap-reverse items-center gap-y-4 justify-between bg-zinc-900/30">
        <div className="flex items-center gap-4">
          <div className="flex flex-col">
            <span className="text-xs text-zinc-500 uppercase">Room Id</span>
            <div className="flex items-center gap-2">
              <span className="bold md:text-lg text-xs text-green-500">
                {roomId}
              </span>
              <button
                onClick={copyLink}
